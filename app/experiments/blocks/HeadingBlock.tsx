...
const mockData = {
    ...
    imageRef: {
        ...
        imageAlt: "An interesting alt text for the image",
    },
    category: {
        title: "Technology",
    },
    heading: "The Reality Is Changing Every Single Day",
    subheading: "Exploring the advancements in artificial intelligence",
    team: {
        slug: {
            current: "raymond",
        },
        image: "/images/raymond.webp",
        name: "Raymond",
    },
};

export { HeadingBlock, mockData };
